...
const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    title: "미팅 기록",
    href: "/activities",
    summary: "투자사와의 미팅·컨택 이력을 한곳에 기록하고 모아 봅니다.",
    items: [
      "상단 ‘미팅 기록’ 버튼으로 투자사(신규/기존)·일자·내용을 남깁니다. 딜 보드 헤더에서도 같은 버튼으로 기록할 수 있습니다.",
      "이름으로 명함을 검색하면 투자사·컨택·연락처가 자동으로 채워집니다.",
      "기간·유형·투자사로 필터링해 전체 이력을 시간순으로 확인합니다.",
      "기록의 투자사명을 누르면 해당 투자사 상세로 이동하며, 거기서도 그 투자사의 미팅 이력만 모아 볼 수 있습니다.",
    ],
    tip: "매물 소개(딜) 없이 조합 정보만 들은 미팅도 여기 남기면 휘발되지 않고 팀에 공유됩니다.",
  },
  {
    icon: Building2,
    title: "투자사",
